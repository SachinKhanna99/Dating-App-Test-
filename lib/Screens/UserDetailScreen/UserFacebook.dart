...
import 'package:datintg_app_test/Screens/UserDetailScreen/userDetail2.dart';
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          else if((!nname.text.isNotEmpty && username.text.isEmpty) )
                          {
                            return "";
                          }
                          if(city.text.isEmpty)
                          {
                            Toast.show("Please Enter Your City", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
                          }
                          else
                          {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => UserDetails2(change?username.text.toString():nname.text.toString())),
                            );
                          }
                          },
                        child: CustomPaint(

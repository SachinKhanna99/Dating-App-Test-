...
class UserDetails2 extends StatefulWidget {
  final String name;
  UserDetails2(this.name);
  @override
  UserDetails2State createState() => UserDetails2State();
}

class UserDetails2State extends State<UserDetails2> {
                          ...
                          if(solo)
                            {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        UserDetails3(widget.name)),
                              );
                            }else
                              {
                                Toast.show("Please Select Gender", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
                              }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Container(
          child: Text(
            "Now let's get started by asking some basic questions",
            style: TextStyle(
              color: Colors.white,
              fontSize: 18.0,
            ),
